...
define('PHP_FIREWALL_LANGUAGE', 'spanish' );
...
/** LANGUAGE */
if ( PHP_FIREWALL_LANGUAGE === 'spanish' ) {
	define ('_PHPF_PROTECTION_DEDIBOX', 'Protección DEDIBOX Server activo, este rango IP no está permitido!');
	define ('_PHPF_PROTECTION_DEDIBOX_IP', 'Protección DEDIBOX Server activo, esta IP no está permitida!');
	define ('_PHPF_PROTECTION_DIGICUBE', 'Protección DIGICUBE Servidor activo, este rango de IP no está permitido!');
	define ('_PHPF_PROTECTION_DIGICUBE_IP', 'Protección DIGICUBE Servidor activo, esta IP no está permitida!');
	define ('_PHPF_PROTECTION_KIMSUFI', 'Protección KIMSUFI Server activo, este rango IP no está permitido!');
	define ('_PHPF_PROTECTION_OVH', 'Protection OVH Server activo, este rango de IP no está permitido!');
	define ('_PHPF_PROTECTION_BOTS', 'Bot ataque detectado, detenerlo ...');
	define ('_PHPF_PROTECTION_CLICK', 'Click attack detectado, detenerlo .....');
	define ('_PHPF_PROTECTION_DOS', 'Agente de usuario no válido, Stop it ...');
	define ('_PHPF_PROTECTION_OTHER_SERVER', 'Publicación desde otro servidor no permitido!');
	define ('_PHPF_PROTECTION_REQUEST', 'Cheque del método de solicitud no válido, Detenlo ...');
	define ('_PHPF_PROTECTION_SANTY', 'Ataque Santy detectado Detenerlo ...');
	define ('_PHPF_PROTECTION_SPAM', 'Protection SPAM IPs activo, este rango de IP no está permitido!');
	define ('_PHPF_PROTECTION_SPAM_IP', 'Protección IPs muertos activos, este rango IP no está permitido!');
	define ('_PHPF_PROTECTION_UNION', 'Ataque de la Union detectado, detenerlo ......');
	define ('_PHPF_PROTECTION_URL', 'URL de protección activa, cadena no permitida!');
	define ('_PHPF_PROTECTION_XSS', 'ataque XSS detectado, detenerlo ...');
} else {
